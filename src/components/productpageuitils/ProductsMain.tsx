...
import { CategoriesForFilterIsSelectedCategoryProductState } from "./filteruitils/CategoriesForFilter";
  ...
  return (
    <div className="products-main">
      ...
      <div className="container-product-main">
          <React.Fragment>
            {hasSelectedCatProd ? <ProductCard selectedCategoryProducts={selectedCategoryProducts} /> : "Məhsul yoxdur."}
          </React.Fragment>
      </div>
    </div>
  );
